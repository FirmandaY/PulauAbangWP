                ...
                <div class="container">
                    <div class="row" style="color:white;">
                        ...
                        <p>
                            ...
                            1. Kategori artikel yang dimiliki <br><br><br>
                            
                        </p>

                        <h4> <strong>Penambahan Artikel Baru</strong> </h4>
                        <p>
                            <strong>Cara 1 : Apabila Kategori Artikel Belum Ada</strong> <br><br>
                            Untuk menambahkan artikel baru, anda perlu untuk menambahkan Kategori terlebih dahulu, caranyaa: <br>
                            ...
                            4. Kemudian isi formulirnya sesuai kategori artikel yang ingin ditambahkan.<br>
                            ...
                            7. Kali ini kita menuju menu <strong>Artikel</strong>, klik untuk masuk <br>
                            8. Nah kita akan disajikan tabel kosong, untuk menambahkan artikel baru klik <button class="btn btn-primary">Tambah artikel</button><br>
                            9. Kemudain isikan formulir tentang artikelnya, untuk lebih mendeskripsikan secara detail, anda dapat menuliskannya di form deskripsi dan konten.<br>
                            10. Setelah selesai tekan tombol <button class="btn btn-warning">Simpan</button>. <br>.<br>
                            11. Jadii deeh! artikel berhasil ditambahkan. Setelah simpan berhasil biasanya anda akan diantar ke daftar umum semua artikel. Untuk melihat
                                secara spesifiknya bisa menuju menu artikelnya lagi.<br> <br> <br>

                            <strong>Cara 2 : Apabila Kategori artikel Sudah Ada</strong> <br><br>
                            Untuk menambahkan prduk baru yang telah tersedia kategorinya: <br>
                            1. Tarik menu (<i class="fa fa-bars"></i>) biru pada samping kiri halaman<br>
                            2. Langsung pilih menu <strong>artikel</strong> dan pilih kategori yang ada. <br>
                            3. Nah kita akan disajikan tabel artikel, untuk menambahkan artikel baru klik <button class="btn btn-primary">Tambah artikel</button><br>
                            4. Kemudain isikan formulir tentang artikelnya, untuk lebih mendeskripsikan secara detail, anda dapat menuliskannya di form deskripsi. <br>
                            5. Setelah selesai tekan tombol <button class="btn btn-warning">Simpan</button>. <br>
                            6. Jadii deeh! artikel baru berhasil ditambahkan. Setelah simpan berhasil biasanya anda akan diantar ke daftar umum semua artikel. Untuk melihat
                                secara spesifiknya bisa menuju menu artikelnya lagi, melalui (<i class="fa fa-bars"></i>) lagi.<br> <br> <br>

                        </p>

                        <h4> <strong>Penambahan Gambar Galeri artikel Baru</strong> </h4>
                        <p>
                            1. Setelah berhasil menambah artikel, kita tarik menu (<i class="fa fa-bars"></i>) biru pada samping kiri lagi,<br>
                            2. Kali ini kita menuju menu <strong>artikel</strong>, klik untuk masuk <br>
                            ...
                            5. Kemudain isikan formulir tentang gambarnya. Isi juga <strong>Merk artikel</strong> sesuai artikelnya. <br>
                        ...
                        <p>
                            <strong>Untuk pengeditan data baik galeri, artikel, maupun kategori perlu diperhatikan baik-baik langkah nya ya.</strong><br><br>
                            1. Klik tombol <button class="btn btn-warning">Edit</button> pada artikel/galeri/kategori yang ingin anda ubah <br>
                            2. Kemudian anda akan diantar menuju halaman formulir untuk edit data.<br>
                            3. Perlu diperhatikan terutama jika mengedit artikel, <strong>Merk/Tipe artikel</strong> harus diisi kembali sebelum di simpan.
